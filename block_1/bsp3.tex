...
\newline
R $ is a certificate relation by construction: S' is a positive instance of $ \textbf{SUBSET SUM} $\leftrightarrow$ the sum of S' elements is exactly t $\leftrightarrow S' \subseteq S $\in R$.
\newline
\newline
